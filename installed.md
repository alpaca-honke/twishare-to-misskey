...
- 【 **新機能** 】v0.2.1で、 **特定のウェブサイトで、右下のシェアボタンを非表示にできる設定** を追加しました。  
※ウェブストアの公開がまだされていない可能性があるので、インストールされたバージョンをご確認ください。

- 【 **仕様変更** 】 **シェアする際に、新規タブやウィンドウで開く** ようになりました。これにより、投稿後の閉じるボタンでほぼ確実に閉じられるようになりました。
一方、シェアする際に新規タブで開く **一部のTwitterシェアボタンでは、投稿後にTwitterタブが残ってしまう** 現象が発生します。
藍ちゃんに免じて許してね<img src="https://s3.arkjp.net/misskey/f6294900-f678-43cc-bc36-3ee5deeca4c2.gif" alt=":ai_norming@misskey.io:" style="height:1.5em;" />
