...
- 【新機能】Twitterのシェアボタンがなくてもシェアできるボタンを追加しました。画面右下の丸いやつです。拡張機能のポップアップ（サーバー名指定するやつ）から表示・非表示の切り替えができます。  
**※Chromeウェブストアではまだこのバージョンは公開されていません。ご注意ください。なお、Chromeでいますぐ最新版を使用したい場合、[リリースページ](https://github.com/alpaca-honke/twishare-to-misskey/releases/tag/0.2.0)から手動インストールしてください。**
